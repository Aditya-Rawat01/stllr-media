...
const SERVICES: Service[] = [
    {
        ...
        description:
            "Still coverage for brands, campaigns and concerts — PAN India via verified behind-the-camera artists",
        image: "/hero/gill.jpg",
    },
    {
        slug: "videography",
        ...
        category: "Motion · 4K",
        description:
            "Motion capture for films, events and concerts — concept to final grade, scalable crew",
        image: "/hero/king.jpg",
    },
    {
        ...
        description:
            "PAN India talent-sourcing — 100+ verified freelancers, photography + videography + post at scale",
    ...
    },
    {
        ...
        description:
            "Platform-ready delivery and digital rollout — edits, grades and assets for brand channels",
...
export default function Services() {
    ...
    const handleMouseMove = (e: React.MouseEvent) => {
        ...
        const clampY = Math.max(
            16,
            Math.min(y, window.innerHeight - cardH - 16),
        );
            ...
            <div className="mx-auto max-w-[1440px] px-6 sm:px-10 lg:px-[6vw]">
                ...
                <div className="pt-8 sm:pt-10 lg:pt-12">
                    ...
                    <p className="mt-3 max-w-[520px] font-[var(--font-dm-sans)] text-[13px] leading-[1.7] text-[#f0ede8]/45 sm:text-[14px]">
                        Production house for brands &amp; creators — not a
                        wedding studio. Four focused crafts, one pipeline.
                    </p>
                </div>

                {/* FULL-WIDTH editorial list — preview only while hovering an actual service row */}
                <div
                ...
                >
                            ...
                            >
                                ...
                                <span
                                    className={[
                                        ...
                                        isActive
                                            ? "text-[#f0ede8]"
                                            : "text-[#f0ede8]/25 group-hover:text-[#f0ede8]/45",
                                    ].join(" ")}
                                >
                                    {service.num}
                                </span>
                                ...
                                <div className="min-w-0 flex-1">
                                    <div className="flex flex-col gap-2 sm:flex-row sm:items-baseline sm:gap-4 lg:gap-6">
                                        <h3
                                            className={[
                                                ...
                                                isActive
                                                    ? "translate-x-1 text-[#f0ede8] sm:translate-x-2"
                                                    : "text-[#f0ede8]/55 group-hover:text-[#f0ede8]/80",
                                            ].join(" ")}
                                            style={{
                                                fontSize:
                                                    "clamp(1.65rem, 3.4vw, 2.65rem)",
                                            }}
                                        >
                                            {service.name}
                                        </h3>
                                    ...
                                    <p
                                        className={[
                                            ...
                                            isActive
                                                ? "text-[#f0ede8]/55"
                                                : "text-[#f0ede8]/32 group-hover:text-[#f0ede8]/45",
                                        ].join(" ")}
                                    >
                                        {service.description}
                                    </p>
                    ...
                    <div
                        ...
                        onPointerLeave={() => setHovered(false)}
                    >
                        <span className="font-[var(--font-dm-sans)] text-[10px] tracking-[0.14em] text-[#f0ede8]/20">
                            04 crafts · New Delhi · stllrmedia@gmail.com
                        </span>
                        <Link
                            href="/#contact"
                            onMouseEnter={() => setHovered(false)}
                            onMouseLeave={() => setHovered(false)}
                            onFocus={() => setHovered(false)}
                            onBlur={() => setHovered(false)}
                    ...
                    >
                        <div className="w-[300px] overflow-hidden border border-[#1f1f1f] bg-[#0e0e0e] shadow-[0_24px_64px_rgba(0,0,0,0.65)] md:w-[320px] lg:w-[360px] xl:w-[380px]">
                            ...
                            <div className="flex items-center justify-between bg-[#0a0a0a] px-4 py-3">
                                ...
                                <span className="font-[var(--font-dm-sans)] text-[9px] tracking-[0.12em] text-[#f0ede8]/30">
                                    {activeService.num}
                                </span>
                            </div>
                        </div>
