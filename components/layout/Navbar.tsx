      ...
      ─────────────────────────────────────────────────────────── */}
            <motion.header
                ...
                style={
                    {
                        height: scrolled ? 56 : NAVBAR_H,
                    } as React.CSSProperties & { height: number }
                }
            >
                <nav
                    className={[
                        ...
                        scrolled
                            ? "max-w-none px-5 sm:px-7 gap-4"
                            : "max-w-[1440px] px-6 sm:px-10 lg:px-[5.5vw]",
                    ].join(" ")}
                >
                    ...
                    >
                        <span className="font-[var(--font-bebas-neue)] text-[1.7rem] tracking-[0.18em]">
                            STLLR
                            <sup className="ml-0.5 align-super font-[var(--font-dm-sans)] text-[0.34em]">
                                ®
                            </sup>
                        </span>
                        <span className="mt-1 font-[var(--font-dm-sans)] text-[7px] font-medium tracking-[0.52em]">
                            MEDIA
                        </span>
                    </Link>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
                        ...
                        <div className="hidden md:flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
                            <Show when="signed-out">
                                <SignInButton mode="modal">
                                    <button className="whitespace-nowrap rounded-full border border-white/20 px-2.5 sm:px-3 py-1.5 text-[10px] sm:text-[10.5px] tracking-[0.18em] uppercase text-[#f0ede8]/80 hover:bg-white hover:text-black">
                                        Sign In
                                    </button>
                                </SignInButton>
                                <SignUpButton mode="modal">
                                    <button className="whitespace-nowrap rounded-full bg-[#f0ede8] px-2.5 sm:px-3 py-1.5 text-[10px] sm:text-[10.5px] tracking-[0.18em] uppercase text-black hover:bg-white">
                                        Sign Up
                                    </button>
                                </SignUpButton>
                            </Show>
                        ...
                        >
                            <span
                                className={[
                                    "block h-px w-[22px] bg-[#f0ede8] origin-center transition-all duration-300",
                                    menuOpen
                            ...
                            <span
                                className={[
                                    "block h-px w-[22px] bg-[#f0ede8] transition-all duration-300",
                                    ...
                                    <Show when="signed-out">
                                        <SignInButton mode="modal">
                                            <button
                                                ...
                                                className="rounded-full border border-white/20 px-4 py-2 text-xs uppercase tracking-[0.18em] text-white"
                                            >
                                                Sign In
                                            </button>
                                        </SignInButton>
                                        <SignUpButton mode="modal">
                                            <button
                                                ...
                                                className="rounded-full bg-white px-4 py-2 text-xs uppercase tracking-[0.18em] text-black"
                                            >
                                                Sign Up
                                            </button>
                                        </SignUpButton>
